 ...
 return (
  <main className="site" style={background}>
   <style>{`
    ...
    /* Player profile pictures: one clean image, no extra avatar ring. */
    .avatar {
    ...
    .avatar.avatar-fallback {
      ...
      border: 1px solid rgba(212, 174, 87, .35) !important;
      background: rgba(212, 174, 87, .08) !important;
      color: #d4ae57;
    }
